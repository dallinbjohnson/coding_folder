<!-- To get to this page you navigate to the products-and-services/connectkey-products.aspx page in the shared folder and choose this printer then the content below will display -->
...
<script runat="server">
	protected void Page_Init(object sender, EventArgs e) {
		...
		austria_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("AT");
		belgiumFrench_pr_b7025.Visible = (AppUtil.Instance.CurrentAccount.MailingCountry.Equals("BE") && AppUtil.Instance.CurrentLanguage.Name == "French");
		...
		finland_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("FI");
		france_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("FR");
		italy_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("IT");
		netherlands_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("NL");
		norway_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("NO");
		portugual_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("PT");
		sweden_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("SE");
		unitedKingdom_pr_b7025.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("GB");

		//Service Ads Logic
		pagePack.Visible = (AppUtil.Instance.CurrentPartnerLevel.ApiName == ("Concessionaire") || AppUtil.Instance.CurrentPartnerLevel.ApiName == ("DocumentTechnologyPartner")) && (AppUtil.Instance.CurrentAccount.CustomValues.HasResponseText(
			"Pricing_Content_Code__cf", "XPPS_ELIGIBLE") || AppUtil.Instance.CurrentAccount.CustomValues.HasResponseText("Pricing_Content_Code__cf", "XPPS_AUTHORIZED"));

		eClick.Visible = (AppUtil.Instance.CurrentPartnerLevel.ApiName == ("Concessionaire") || AppUtil.Instance.CurrentPartnerLevel.ApiName == ("DocumentTechnologyPartner")) && (AppUtil.Instance.CurrentAccount.CustomValues.HasResponseText(
			"Pricing_Content_Code__cf", "XPPS_ELIGIBLE") || AppUtil.Instance.CurrentAccount.CustomValues.HasResponseText("Pricing_Content_Code__cf", "XPPS_AUTHORIZED"));

		pageConnect.Visible = (AppUtil.Instance.CurrentPartnerLevel.ApiName == ("Concessionaire") || AppUtil.Instance.CurrentPartnerLevel.ApiName == ("DocumentTechnologyPartner")) && AppUtil.Instance.CurrentAccount.CustomValues.HasResponseText(
			"Pricing_Content_Code__cf", "XPPS_ELIGIBLE");

		amps.Visible = (AppUtil.Instance.CurrentPartnerLevel.ApiName == ("Concessionaire") || AppUtil.Instance.CurrentPartnerLevel.ApiName == ("DocumentTechnologyPartner")) && AppUtil.Instance.CurrentAccount.CustomValues.HasResponseText(
			"Pricing_Content_Code__cf", "XPPS_AUTHORIZED");

		//Country Codes for Product Brochures (sales tab)
		austria_product_brochure.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("AT");
		belgiumFrench_product_brochure.Visible = (AppUtil.Instance.CurrentAccount.MailingCountry.Equals("BE") && AppUtil.Instance.CurrentLanguage.Name == "French");
		...
		//Product Brochure 2
		austria_product_brochure_2.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("AT");
		belgiumFrench_product_brochure_2.Visible = (AppUtil.Instance.CurrentAccount.MailingCountry.Equals("BE") && AppUtil.Instance.CurrentLanguage.Name == "French");
		...
		italy_product_brochure_2.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("IT");
		netherlands_product_brochure_2.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("NL");
		norway_product_brochure_2.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("NO");
		portugual_product_brochure_2.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("PT");
		...
		austria_specs.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("AT");
		belgiumFrench_specs.Visible = (AppUtil.Instance.CurrentAccount.MailingCountry.Equals("BE") && AppUtil.Instance.CurrentLanguage.Name == "French");
		...
		italy_specs.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("IT");
		netherlands_specs.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("NL");
		norway_specs.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("NO");
		portugal_specs.Visible = AppUtil.Instance.CurrentAccount.MailingCountry.Equals("PT");
...
<div class="tab-content">
	<div id="b8045-overview" class="tab-pane fade in active">
		...
		<div id="versalink_keyFeatures">
			<img src="~/images/products/connectKey_b8000_overview.jpg" runat="server" alt="connectKey b8000 overview" style="margin: 0 0 -15px 10px; width: 92.75%;" />
		...
		<p>Notre imprimante multifonctions intelligente noir et blanc est capable de modifier votre fa&ccedil;on de travailler. Offrant une exp&eacute;rience de nouvelle g&eacute;n&eacute;ration id&eacute;ale pour les utilisateurs mobiles, la s&eacute;rie AltaLink
			B8045 associe facilit&eacute; d'utilisation et s&eacute;curit&eacute;, tout en pr&eacute;voyant l'&eacute;volutivit&eacute; des flux de travail bas&eacute;s sur les applications. Exploitez ses fonctionnalit&eacute;s pour transformer d'abord le parc
			de vos clients puis leur entreprise.</p>
		<h3>Intelligence et performance</h3>
		<p>De l'&eacute;cran tactile couleur 10 pouces inclinable, qui permet une navigation intuitive bas&eacute;e sur les gestes, au scanner monopasse haute vitesse avec fonction OCR int&eacute;gr&eacute;e, ou aux applications Xerox ConnectKey t&eacute;l&eacute;chargeables
			depuis Xerox App Gallery pour automatiser les t&acirc;ches courantes, l'AltaLink s&eacute;rie B est con&ccedil;ue pour am&eacute;liorer l'efficacit&eacute;, permettre le fonctionnement multit&acirc;che et favoriser la collaboration au sein du bureau.</p>
		<p>Facile &agrave; g&eacute;rer, aussi bien en tant que syst&egrave;me autonome qu'au sein d'un parc d'imprimantes. Le nouveau serveur Web int&eacute;gr&eacute; et les fonctionnalit&eacute;s MPS am&eacute;lior&eacute;es permettent un d&eacute;ploiement
			plus rapide et une meilleure gestion des appareils. Gr&acirc;ce &agrave; des fonctionnalit&eacute;s comme l'installation sans intervention, le clonage, la configuration/sauvegarde/restauration &agrave; distance et la mise &agrave; niveau logicielle
			plus rapide, l'imprimante est simple &agrave; utiliser et &agrave; entretenir. De plus, l'interface utilisateur distante permet la fourniture de service et la formation &agrave; distance.</p>
		<h3>Puissance et &eacute;volutivit&eacute;</h3>
		<p>Cr&eacute;ez des flux de travail personnalis&eacute;s, automatisez des t&acirc;ches complexes, imprimez et num&eacute;risez directement vers et depuis le cloud avec des services comme Google Drive&trade;, Microsoft&reg; OneDrive&reg; et DropBox&trade;.
			Connectez-vous ais&eacute;ment aux mobiles avec Apple&reg; AirPrint&reg;, Google Cloud Print&trade;, et Mopria&reg;. La fonction pair &agrave; pair Near Field Communication (NFC), int&eacute;gr&eacute;e en standard, permet de connecter ais&eacute;ment
			un appareil mobile &agrave; l'imprimante ; de plus, les fonctionnalit&eacute;s Wi-Fi et Wi-Fi Direct en option vous permettent de positionner vos appareils sans c&acirc;blage.</p>
		...
		<p>Diff&eacute;rents niveaux de s&eacute;curit&eacute; garantis par des partenaires du secteur comme Cisco et McAfee assurent une assistance proactive pour les documents et les donn&eacute;es. La puissante technologie de liste blanche, le cryptage des
			donn&eacute;es, le nettoyage du disque et l'impression s&eacute;curis&eacute;e avec protection par mot de passe et cryptage de McAfee contribuent &agrave; prot&eacute;ger des menaces &eacute;mergentes et respectent ou d&eacute;passent la conformit&eacute;
			r&eacute;glementaire, quel que soit le secteur d'activit&eacute; de vos clients.</p>
		<p>&nbsp;</p>
		<p><a href="www.xerox.com/AltalinkB8000Specs" target="_blank">Sp&eacute;cifications d&eacute;taill&eacute;es du produit</a></p>
		<p>
			<ResellerViewControls:BackpackLink runat="server" TargetSystem="SmartCentre" TargetUrl="https://smartcentre.xerox.com/auth/portalauth.aspx" LinkText="Ressources produit" Destination="/Products-and-Services/Office/Products/BW-Multifunction/AltaLink-B8045/B8055/B8065/B8075/B8090/"
			/>
		</p>
		<p>
			<ResellerViewControls:BackpackLink runat="server" TargetSystem="Lamp" TargetUrl="https://www.office.xerox.com/resellers/" LinkText="Liste des prix" />
		</p>
		<p>&nbsp;</p>
	</div>
	<div id="b8045-marketOpportunity" class="tab-pane fade">
		...
		<img src="~/images/products/connectKey_b8000_marketOpportunity.jpg" alt="connectKey b8000 market Opportunity" runat="server" style="border:1px solid lightgray; margin:10px 0; width:60%;" />
		...
		<p>Profitez de la gestion, du suivi &agrave; distance et de la mise &agrave; niveau des capacit&eacute;s en standard sur les imprimantes multifonctions AltaLink B8045 , un avantage concurrentiel permettant de renforcer la satisfaction et la fid&eacute;lisation
			des clients.</p>
	...
	<div id="b8045-salesResources" class="tab-pane fade">
		...
		<div style="float: right; width: 55%; text-align: center; padding: 0px 20px 10px 55px; margin-top:15px;">
			<img src="~/images/products/connectKey_b8000_salesResources.jpg" alt="connectKey b8000 salesResources" runat="server" />
		</div>
		...
		<ul>
			...
			<li>
				<ResellerViewControls:BackpackLink runat="server" TargetSystem="SmartCentre" TargetUrl="https://smartcentre.xerox.com/auth/portalauth.aspx" LinkText="Livre blanc produit AltaLink" Destination="/Products-and-Services/Office/Products/BW-Multifunction/AltaLink-B8045/B8055/B8065/B8075/B8090/"
				/>
			</li>
			<li>
				<ResellerViewControls:BackpackLink runat="server" TargetSystem="SmartCentre" TargetUrl="https://smartcentre.xerox.com/auth/portalauth.aspx" LinkText="Fiche outil Serveur Web int&eacute;gr&eacute;" Destination="/Products-and-Services/Office/Products/BW-Multifunction/AltaLink-B8045/B8055/B8065/B8075/B8090/"
				/>
			</li>
			<li><a href="http://www.office.xerox.com/latest/XOGFS-14.PDF" target="_blank">Matrice des homologations</a></li>
			<li><a href="https://www.learning.xerox.com/USR/servlet/LAXEnter?entryPoint=findLearning.resourceDetails&shortcode=OS2085" target="_blank">Plateforme de formation Ventes (OS2085)</a> Formation commerciale sous forme de modules, ais&eacute;ment accessible
		...
		<p id="showroomCover" runat="server"><a href="../partner-program/partner-showrooms.aspx">La garantie Showroom </a> est un contrat gratuit qui garantit le bon fonctionnement permanent des &eacute;quipements de d&eacute;monstration install&eacute;s dans votre showroom. Ce contrat de r&eacute;paration
			couvre uniquement vos sites de showroom.</p>
	</div>
	<div id="b8045-addMoreValue" class="tab-pane fade">
		...
		<div style="float: right; width: 50%; text-align: center; padding: 0px 20px 10px 55px; margin-top:-15px;">
			<p><img src="~/images/products/connectKey_b8000_addMoreValue.jpg" alt="connectKey b8000 add More Value" runat="server" /></p>
		</div>
		<p>Bien plus qu'une machine - des options qui vous aideront &agrave; augmenter la valeur de chaque vente :</p>
		<h3>Options</h3>
		<p><b>1. Vous anticipez des volumes d'impression &eacute;lev&eacute;s ?</b><br> Ajoutez davantage de capacit&eacute; papier avec un chargeur 3 300 feuilles haute capacit&eacute;</p>
		<p><b>2.  Des applications de publipostage ?</b><br> Ajoutez un magasin pour enveloppes</p>
		...
		<p>&nbsp;</p>
		<h3>Solutions</h3>
		<img src="~/images/products/connectKey-solutions-selector-thumbnail.png" alt="connectKey solutions selector" runat="server" style="border:1px solid lightgray; float:left; margin:0 15px 15px 0;" />
		...
		<table>
			<tr>
				<td id="pagePack" runat="server" style="width:32%;">
					<div style="border:3px solid orange; padding:0 15px 0 15px; width:90%; height:470px;">
				...
				<td id="eClick" runat="server" style="width:32%;">
					<div style="border:3px solid orange; padding:0 15px 0 15px; width:90%; height:470px;">
				...
				<td id="pageConnect" runat="server" style="width:32%;">
					<div style="border:3px solid orange; padding:0 15px 0 15px; width:90%; height:470px;">
						...
						<hr>
						<p><b>Services PageConnect :</b> propose un r&eacute;approvisionnement proactif en consommables ainsi qu'une assistance technique pour le parc de votre client pour la plupart des marques concurrentes d'imprimantes et de multifonctions A4, ainsi que
							toutes les machines PagePack Xerox.</p>
				...
				<td id="amps" runat="server" style="width:32%;">
					<div style="border:3px solid orange; padding:0 15px 0 15px; width:90%; height:470px;">
	...
	<div id="b8045-marketingSupport" class="tab-pane fade">
		...
		<div style="float: right; width: 45%; text-align: center; padding-left: 15px; margin-bottom:20px;">
			<img src="~/images/products/connectKey_b7000_marketingSupport.jpg" alt="connectKey b7000 marketing Support" runat="server" />
		</div>
		...
		<ul>
			<li><b>Liste de produits</b> &emsp; <span id="ccssDTP26" runat="server"><a href="../marketing/optimise-your-website.aspx#xeroxcontent">Widget de contenu Xerox </a></span></li>
			...
			<li><b>Photographie</b> &emsp;
				<ResellerViewControls:BackpackLink runat="server" TargetSystem="SmartCentre" TargetUrl="https://smartcentre.xerox.com/auth/portalauth.aspx" LinkText="Photographie produit" Destination="/Products-and-Services/Marketing-Store/Product-Photography/" /> &emsp;
			...
			<li><b>Outils interactifs</b> &emsp; <a href="http://a400.g.akamai.net/7/400/5566/v0001/xerox.download.akamai.com/5566/AltaLinkB8000_US/index.htm" target="_blank">D&eacute;mo virtuelle</a> &emsp; <a href="http://a400.g.akamai.net/7/400/5566/v0001/xerox.download.akamai.com/5566/AltaLinkSIM/index.htm"
				  target="_blank">Simulateur d'interface utilisateur</a></li>
		</ul>
		<div id="ccssDTP27" runat="server">
			...
			<ul>
				<li>Optimisation pour les moteurs de recherche (SEO) Suggestion de termes &mdash;
					<TreeHouseI:ImageHtmlToolTip ToolTipHtml="<div class='boxed'>La cat&eacute;gorie de produits g&eacute;n&eacute;riques plus votre situation g&eacute;ographique constituent probablement les mots-cl&eacute;s les plus efficaces pour le r&eacute;f&eacute;rencement naturel de votre site Web. Ex. : imprimantes multifonctions couleur, Toulouse, France. Pour les nouveaux produits, nous vous conseillons d\u0027ajouter la marque/le nom du mod&egrave;le et votre situation g&eacute;ographique dans votre liste SEO. Notez cependant qu\u0027il faut un certain temps avant que les internautes ne connaissent le nom de la marque ou du mod&egrave;le et ne les utilisent comme mots-cl&eacute;s dans leurs recherches. Ex. : Phaser 3260 Toulouse, France.</div>"
					  runat="server" /> &emsp; <span id="seoCcssDTP2" runat="server">
		...
		<ul>
			<li><b>Ressources</b> &emsp; <a href="http://www.office.xerox.com/latest/AB8PS-01U.PDF" target="_blank">&Eacute;chantillons d'impression</a> &emsp;
				<ResellerViewControls:BackpackLink runat="server" TargetSystem="SmartCentre" TargetUrl="https://smartcentre.xerox.com/auth/portalauth.aspx"
				  Destination="/Products-and-Services/Office/Products/BW-Multifunction/AltaLink-B8045/B8055/B8065/B8075/B8090/" LinkText="Script de d&eacute;monstration" /> &emsp;
				<ResellerViewControls:BackpackLink runat="server" TargetSystem="SmartCentre" TargetUrl="https://smartcentre.xerox.com/auth/portalauth.aspx" Destination="/Products-and-Services/Office/Products/BW-Multifunction/AltaLink-B8045/B8055/B8065/B8075/B8090/"
				  LinkText="Kits Salle d&eacute;mo" />
		</ul>
